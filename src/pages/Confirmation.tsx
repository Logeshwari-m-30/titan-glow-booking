  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center py-8 px-4">
      <div className="max-w-lg mx-auto text-center">
        <div className="w-20 h-20 rounded-full gradient-neon mx-auto flex items-center justify-center mb-6 neon-glow-blue animate-pulse-neon">
        ...
        <Link to="/">
          <Button variant="outline" className="neon-border bg-card">
