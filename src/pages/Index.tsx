      ...
      <div className="min-h-screen bg-background relative z-10">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <img src={gamingBg} alt="Gaming cafe" className="w-full h-full object-cover opacity-30 blur-[2px]" width={1920} height={1080} />
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <div className="mt-6">
              <Link to="/booking">
                <Button size="lg" className="gradient-neon text-primary-foreground font-heading text-lg px-10 py-7 animate-glow-breathe hover:scale-110 transition-transform duration-300">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {consoles.map((c, i) => (
                <div
                  key={c.name}
                  className="bg-card rounded-xl p-8 neon-border text-center slot-card-hover group"
