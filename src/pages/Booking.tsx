    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex gap-2 mb-10">
          {[1, 2].map((s) => (
            <div key={s} className={cn("h-1.5 flex-1 rounded-full transition-colors", s <= step ? "gradient-neon" : "bg-muted")} />
          ))}
        </div>
        ...
        <div className="mt-10 flex gap-4">
          ...
          <Button
            disabled={!canProceed()}
            className="flex-1 gradient-neon text-primary-foreground font-heading neon-glow-blue hover:scale-[1.02] transition-transform disabled:opacity-40"
